...
/*
Elements() []int return all the elements represented as slice of all the blocks
*/
...
/*
Add(values ...int) adds all the passed elements to the set
*/
...
/*
Remove(values ...int) removes all the passed elements from the set
*/
...
/*
Has(x int) reports whether the set contains non-negative value x
*/
...
/*
IntersectWith(t *IntSet) sets s to the intersection of s and t
*/
...
/*
DifferenceWith(t *IntSet) sets s to the difference of s and t (excludes all the elements of t from s)
*/
...
/*
SymmetricDifference(t *IntSet) *IntSet returns the symmetric difference of s and t
*/
...
/*
subAdd(x int) adds the non-negative value x to the set
*/
...
/*
subRemove(x int) turns an element at words[blockIndex][indexInBlock] into 0
*/
...
/*
getBlockAndIndex(x int) returns the block index and the index in this block if the element is consisted by set
...
/*
minLen(s, t *IntSet) int returns the minimal length of underlying slices of s and t
*/
